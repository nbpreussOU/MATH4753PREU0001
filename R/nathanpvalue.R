...
#' @param xmax the highest possible t statistic
#' @param n the number of samples to create
#' @param alpha alpha value for a 1-alpha percent confidence interval
#' @return This function returns a graph of the t statistic with the sample mean and the area described, and a list containing the bounds on the rejection region as well as the p value
#'
#' @export
#'
nathanpvalue=function(t0,xmax=4,n=20, alpha=0.05){
  #calculate alpha/2
