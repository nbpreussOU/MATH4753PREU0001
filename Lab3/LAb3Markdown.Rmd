...
```{r}
library(ggplot2)
z<-ggplot(spruce.df, aes(x=BHDiameter, y=Height)) + geom_point() + geom_line() + ggtitle("Nathan Preuss") + geom_smooth(method='lm', formula= y~x)
z
```
...
<center>
!["Straight Simple Linear Regression"](lr.JPG){ width=70% }
!["Points Alone"](p.JPG){ width=70% }
!["Points Joined With Line Segments"](cl.JPG){ width=70% }
</center>
